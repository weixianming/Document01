...
import xianming.model.UserReadDocument;
...
public class DocumentService implements IDocumentService {
	...
	private List<Attachment> listAttachByDocument(int id){
		String hql = "from Attachment att where att.document.id=?";
