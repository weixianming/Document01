...
<table width="900" cellpadding="0" cellspacing="0" class="ct">
	<tr>
		<td>标识：</td><td>${department.id}</td>
	</tr>
	<tr>
		<td>名称：</td><td>${department.name }</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2">
		<s:checkboxlist theme="simple" list="#ds" listKey="id" listValue="name" name="sdeps"
		 value="#ads"/>
	...
	<tr>
		<td colspan="2">
			<input type="submit" value="设置发文部门">
		</td>
	</tr>
</table>
</form>
